...
{
    LED_ON();
    //HAL_UART_Transmit(&huart1, tData, sizeof(tData) / sizeof(uint8_t), 1000);
    HAL_UART_Receive_IT(&huart1, rData, 16);
    OLED_ShowString(2, 1, (char*)rData);
    LED_OFF();
}
/* USER CODE END 4 */
