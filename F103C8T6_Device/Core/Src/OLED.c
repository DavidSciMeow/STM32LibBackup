...
/*引脚配置*/
#define OLED_W_D0(x)		HAL_GPIO_WritePin(LED_SCL_GPIO_Port, LED_SCL_Pin, (GPIO_PinState)(x))
#define OLED_W_D1(x)		HAL_GPIO_WritePin(LED_SDA_GPIO_Port, LED_SDA_Pin, (GPIO_PinState)(x))
#define OLED_W_RES(x)		HAL_GPIO_WritePin(LED_RES_GPIO_Port, LED_RES_Pin, (GPIO_PinState)(x))
